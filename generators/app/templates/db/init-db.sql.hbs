-- generators/app/templates/db/init-db.stub.sql

-- BOILERPLATE STUB
-- ตรงนี้คือสคริปต์สำหรับสร้าง schema, table และ trigger
-- ปรับแต่งชื่อ schema/table ตามโปรเจกต์ของคุณได้
...
-- TODO: ถ้าต้องการ table หรือ index เพิ่มเติม ให้แก้ตรงนี้
